...
if __name__ == "__main__":
    API_KEY = passwordVault.get('BITTREX_API_KEY')
    API_SECRET = passwordVault.get('BITTREX_API_SECRET')

    b = Bittrex(api_key=API_KEY, api_secret=API_SECRET, calls_per_second=1, dispatch=using_requests, api_version=API_V1_1)
